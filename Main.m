...
opt.Nz = 60;
opt.n_m = 1;
opt.lambdaR = 0.622 / opt.n_m;    % Red wavelength [um].
opt.lambdaG = 0.528 / opt.n_m;    % Green wavelength [um].
opt.lambdaB = 0.469 / opt.n_m;    % Blue wavelength [um].
opt.Mag = 20;                     % Objective magnification.
opt.pixelsize = 2.5 / opt.Mag;    % Effective camera sampling size [um].
